...
public class ByteCodeLoader extends Object {
    ...
    public Program loadCodes() {
        String line;
        String byteCodeName; // Byte oce name from .x.cod file
        ...
        try {
            while (this.byteSource.ready()) {
                ...
                //Clear arguments for the next ByteCode
                args.clear();
        ...
        //Resolve the addresses for the goto,call,falsebranch so that they know where to jump to beforehand
